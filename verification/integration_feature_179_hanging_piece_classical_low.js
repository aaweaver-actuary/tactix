...
const GAME_ID =
  process.env.TACTIX_HANGING_PIECE_GAME_ID || 'classical-hanging-piece-low';
...
(async () => {
  try {
    ...
    console.log('Feature 179 integration check ok');
  } catch (err) {
    console.error('Feature 179 integration check failed:', err);
    process.exit(1);
  }
})();
