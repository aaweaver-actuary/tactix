...
row = conn.execute(
    ...
    WHERE p.source = 'chesscom'
      AND p.uci = 'f4e2'
      AND COALESCE(r.time_control, 'unknown') = '86400'
...
if result is None:
    raise SystemExit("No tactic result for correspondence fork fixture")
...
print("seeded correspondence fork tactic into data/tactix.duckdb")
