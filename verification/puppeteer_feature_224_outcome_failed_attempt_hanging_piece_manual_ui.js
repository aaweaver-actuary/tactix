...
const SCREENSHOT_NAME =
  ...
  'feature-224-outcome-failed-attempt-hanging-piece-2026-01-31.png';
  ...
  try {
    ...
    const hasTableRow = await page.evaluate(() => {
      ...
      return rows.some((row) => {
        ...
        return text.includes('failed_attempt') && text.includes('hanging_piece');
      });
    });
    if (!hasTableRow) {
      throw new Error(
        'Recent tactics table missing failed_attempt hanging_piece row',
      );
    }
