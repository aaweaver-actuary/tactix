...
def _hanging_piece_fixture_position() -> dict[str, object]:
    ...
    hanging_chunk = next(
        chunk for chunk in chunks if "Blitz Fixture 12 - Hanging Piece High" in chunk
    )
...
if result is None:
    raise SystemExit("No tactic result for hanging piece blitz fixture")
...
print("seeded hanging piece blitz high tactic into data/tactix.duckdb")
