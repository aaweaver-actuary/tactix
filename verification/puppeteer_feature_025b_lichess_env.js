...
const SCREENSHOT_NAME =
  ...
  'feature-025b-lichess-env-2026-01-25.png';
...
const LICHESS_USERNAME = process.env.LICHESS_USERNAME || 'unknown';
...
(async () => {
  ...
  try {
    ...
    const expected = `user ${LICHESS_USERNAME}`.toLowerCase();
    if (!html.toLowerCase().includes(expected)) {
      throw new Error(`Expected UI to include ${expected}.`);
    }
