...
const screenshotName =
  ...
  'feature-052-chesscom-correspondence-backfill-2026-01-25.png';
  ...
  try {
    ...
    try {
      ...
      const htmlPath = path.join(
        outDir,
        'failed-feature-052-chesscom-correspondence-backfill-debug.html',
      );
    ...
    console.error('Feature 052 verification failed:', err);
    process.exit(1);
  } finally {
    await browser.close();
    preview.kill();
