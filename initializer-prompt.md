...
Start by reading `app-spec.txt` in your working directory. This file contains
...
- Cover every feature in the spec exhaustively and in different scenarios
- You _MUST NEVER_ duplicate features; each must be unique. Review carefully to avoid overlap.
...
2. Create `app-progress.txt` with a summary of what you accomplished
