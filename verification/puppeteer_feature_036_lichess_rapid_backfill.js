...
const screenshotName =
  ...
  'feature-036-lichess-rapid-backfill-2026-01-25.png';
...
(async () => {
  ...
  try {
    ...
    await page.select('[data-testid="filter-lichess-profile"]', 'rapid');
    ...
    console.error('Feature rapid backfill verification failed:', err);
    process.exit(1);
  } finally {
    await browser.close();
  }
