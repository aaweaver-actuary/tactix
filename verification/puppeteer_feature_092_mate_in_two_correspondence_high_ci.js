...
console.log('Starting feature 092 Puppeteer run...');
...
const SCREENSHOT_NAME =
  ...
  'feature-092-mate-in-2-correspondence-high-severity-ci-2026-01-26.png';
  ...
  try {
    ...
    const hasHighSeverity = Array.isArray(severityCheck?.tactics)
      ? severityCheck.tactics.some(
          (row) => row.best_uci === 'c5f2' && row.severity >= 1.5,
        )
      : false;
