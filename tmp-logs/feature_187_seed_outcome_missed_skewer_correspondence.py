...
def _find_missed_position(
    ...
    raise SystemExit("No missed outcome found for skewer fixture")
...
with StockfishEngine(settings) as engine:
    missed_position, result = _find_missed_position(position, engine, settings, "skewer")

tactic_row, outcome_row = result
if outcome_row["result"] != "missed":
    raise SystemExit("Expected missed outcome for skewer correspondence fixture")
...
print("seeded skewer (correspondence) missed outcome into data/tactix.duckdb")
