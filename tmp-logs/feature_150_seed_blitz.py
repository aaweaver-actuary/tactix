...
def _discovered_attack_fixture_position() -> dict[str, object]:
    ...
    raise SystemExit("No discovered attack blitz fixture position found")
...
if result is None:
    raise SystemExit("No tactic result for discovered attack blitz fixture")
...
print("seeded discovered attack blitz tactic into data/tactix.duckdb")
