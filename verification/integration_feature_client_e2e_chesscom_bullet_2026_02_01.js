...
const BACKEND_PORT = process.env.TACTIX_BACKEND_PORT || '8005';
const DEV_SERVER_PORT = process.env.TACTIX_UI_PORT || '5182';
const API_BASE =
...
const DUCKDB_PATH =
  ...
  path.resolve(
    ROOT_DIR,
    'tmp-logs',
    'feature_client_e2e_chesscom_bullet_2026_02_01_integration.duckdb',
  );
