...
const screenshotName =
  ...
  'feature-032-lichess-bullet-backfill-2026-01-25.png';
...
(async () => {
  ...
  try {
    ...
    await page.select('[data-testid="filter-lichess-profile"]', 'bullet');
    ...
    console.error('Feature 032 bullet backfill verification failed:', err);
    process.exit(1);
  } finally {
    await browser.close();
  }
