...
const GAME_ID =
  process.env.TACTIX_HANGING_PIECE_GAME_ID || 'rapid-hanging-piece-low';
...
(async () => {
  try {
    ...
    console.log('Feature 178 integration check ok');
  } catch (err) {
    console.error('Feature 178 integration check failed:', err);
    process.exit(1);
  }
})();
