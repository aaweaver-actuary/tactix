...
class HangingPieceCorrespondenceTests(unittest.TestCase):
    ...
    def test_correspondence_hanging_piece_is_low_severity(self) -> None:
        ...
        position = hanging_piece_fixture_position(
            ...
            label="Correspondence Fixture 11 - Hanging Piece Low",
            game_id="correspondence-hanging-piece-low",
        )

        tmp_dir = Path(tempfile.mkdtemp())
        conn = get_connection(tmp_dir / "hanging_piece_correspondence.duckdb")
        init_schema(conn)
    ...
    def test_correspondence_hanging_piece_is_high_severity(self) -> None:
        ...
        position = hanging_piece_high_fixture_position(
            fixture_filename="chesscom_correspondence_sample.pgn",
            label="Correspondence Fixture 12 - Hanging Piece High",
