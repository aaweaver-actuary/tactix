...
def _find_missed_position(
    ...
    raise SystemExit("No missed outcome found for mate in one fixture")
...
with StockfishEngine(settings) as engine:
    missed_position, result = _find_missed_position(mate_position, engine, settings, "mate")

tactic_row, outcome_row = result
if outcome_row["result"] != "missed":
    raise SystemExit("Expected missed outcome for mate in one rapid fixture")
...
print("seeded mate in one (rapid) missed outcome into data/tactix.duckdb")
