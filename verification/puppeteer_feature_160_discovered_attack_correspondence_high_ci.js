...
console.log('Starting feature 160 Puppeteer run...');
...
const SCREENSHOT_NAME =
  ...
  'feature-160-discovered-attack-correspondence-high-severity-ci-2026-01-28.png';
const GAME_ID =
    ...
    const hasHighSeverity = Array.isArray(severityCheck?.tactics)
      ? severityCheck.tactics.some(
          (row) =>
            ...
            row.game_id === GAME_ID &&
            Number(row.severity) >= MIN_SEVERITY,
        )
      : false;
