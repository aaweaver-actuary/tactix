...
def _skewer_fixture_position() -> dict[str, object]:
    ...
    for chunk in chunks:
        ...
        return {
            "game_id": f"{extract_game_id(chunk)}-classical",
            "user": "chesscom",
            "source": "chesscom",
            "fen": board.fen(),
            "ply": board.ply(),
...
if result is None:
    raise SystemExit("No tactic result for skewer classical fixture")
...
print("seeded skewer classical tactic into data/tactix.duckdb")
