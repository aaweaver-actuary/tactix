...
console.log('Starting feature 093 Puppeteer run...');
...
const SCREENSHOT_NAME =
  ...
  'feature-093-fork-bullet-low-severity-ci-2026-01-26.png';
  ...
  try {
    ...
    const severityCheck = await page.evaluate(async (apiBase) => {
      const res = await fetch(
        `${apiBase}/api/dashboard?source=chesscom&motif=fork&time_control=60`,
        {
