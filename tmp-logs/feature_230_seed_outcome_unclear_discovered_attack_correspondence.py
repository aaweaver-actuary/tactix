...
def _build_unclear_result(
    ...
    if result is None:
        raise SystemExit("No result for discovered attack unclear seed position")
    tactic_row, outcome_row = result
    if tactic_row["motif"] != "discovered_attack" or outcome_row["result"] != "unclear":
        raise SystemExit("Expected unclear discovered attack outcome for seed position")
...
print("seeded discovered attack (correspondence) unclear outcome into data/tactix.duckdb")
