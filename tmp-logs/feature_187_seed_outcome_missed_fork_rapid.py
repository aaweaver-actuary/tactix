...
def _find_missed_position(
    ...
    raise SystemExit("No missed outcome found for fork fixture")
...
if outcome_row["result"] != "missed":
    raise SystemExit("Expected missed outcome for fork rapid fixture")
...
print("seeded fork (rapid) missed outcome into data/tactix.duckdb")
