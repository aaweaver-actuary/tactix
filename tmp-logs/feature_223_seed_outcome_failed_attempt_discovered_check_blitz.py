...
def _find_failed_attempt_position(
    ...
    raise SystemExit("No failed_attempt outcome found for discovered check fixture")
...
if outcome_row["result"] != "failed_attempt":
    raise SystemExit("Expected failed_attempt outcome for discovered check blitz fixture")
...
print("seeded discovered check (blitz) failed_attempt outcome into data/tactix.duckdb")
