...
console.log('Starting feature 084 Puppeteer run...');
...
const SCREENSHOT_NAME =
  ...
  'feature-084-mate-in-2-blitz-low-severity-ci-2026-01-26.png';
  ...
  try {
    ...
    const severityCheck = await page.evaluate(async (apiBase) => {
      const res = await fetch(
        `${apiBase}/api/dashboard?source=chesscom&motif=mate&time_control=300`,
        {
