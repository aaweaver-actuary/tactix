...
def _find_missed_position(
    ...
    raise SystemExit("No missed outcome found for pin fixture")
...
with StockfishEngine(settings) as engine:
    missed_position, result = _find_missed_position(position, engine, settings, "pin")

tactic_row, outcome_row = result
if outcome_row["result"] != "missed":
    raise SystemExit("Expected missed outcome for pin correspondence fixture")
...
print("seeded pin (correspondence) missed outcome into data/tactix.duckdb")
