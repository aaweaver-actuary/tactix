...
const SCREENSHOT_OPEN =
  ...
  'feature-fab-browser-modal-open-2026-02-10.png';
const SCREENSHOT_CLOSED = 'feature-fab-browser-modal-closed-2026-02-10.png';
...
(async () => {
  ...
  try {
    ...
    if (!modalText.includes(fen)) {
      throw new Error('Browser modal does not show the expected FEN.');
    }
