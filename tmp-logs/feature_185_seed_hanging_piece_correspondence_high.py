...
def _hanging_piece_fixture_position() -> dict[str, object]:
    ...
    hanging_chunk = next(
        chunk for chunk in chunks if "Correspondence Fixture 12 - Hanging Piece High" in chunk
    )
...
print("seeded hanging piece correspondence high tactic into data/tactix.duckdb")
