...
console.log('Starting feature 082 Puppeteer run...');
...
const SCREENSHOT_NAME =
  ...
  'feature-082-mate-in-1-correspondence-high-severity-2026-01-26.png';
  ...
  try {
    ...
    const severityCheck = await page.evaluate(async (apiBase) => {
      const res = await fetch(
        `${apiBase}/api/dashboard?source=chesscom&motif=mate&time_control=86400`,
        {
