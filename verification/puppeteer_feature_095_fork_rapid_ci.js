...
console.log('Starting feature 095 Puppeteer run...');
...
const SCREENSHOT_NAME =
  ...
  'feature-095-fork-rapid-low-severity-ci-2026-01-26.png';
  ...
  try {
    ...
    const severityCheck = await page.evaluate(async (apiBase) => {
      const res = await fetch(
        `${apiBase}/api/dashboard?source=chesscom&motif=fork&time_control=600`,
        {
