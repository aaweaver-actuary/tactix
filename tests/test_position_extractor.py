...
class PositionExtractorTests(unittest.TestCase):
    ...
    def test_extracts_chesscom_blitz_black_to_move_positions(self) -> None:
        pgn = self.chesscom_games[1]
        positions = extract_positions(
            pgn,
            user="chesscom",
    ...
    def test_chesscom_blitz_black_filter_skips_white_user(self) -> None:
        pgn = self.chesscom_games[0]
        positions = extract_positions(
            pgn,
            user="chesscom",
    ...
    def test_extracts_chesscom_bullet_black_to_move_positions(self) -> None:
        pgn = self.chesscom_bullet_games[1]
        positions = extract_positions(
            pgn,
            user="chesscom",
            source="chesscom",
        ...
        self.assertEqual(first["move_number"], 1)
        self.assertEqual(first["side_to_move"], "black")
        self.assertEqual(first["uci"], "g8f6")
        self.assertEqual(first["san"], "Nf6")
        self.assertEqual(first["clock_seconds"], 60)
        self.assertTrue(first["is_legal"])

    def test_chesscom_bullet_black_filter_skips_white_user(self) -> None:
    ...
    def test_extracts_chesscom_classical_black_to_move_positions(self) -> None:
        pgn = self.chesscom_classical_games[1]
        positions = extract_positions(
            pgn,
            user="chesscom",
            source="chesscom",
    ...
    def test_chesscom_classical_black_filter_skips_white_user(self) -> None:
        pgn = self.chesscom_classical_games[0]
        positions = extract_positions(
            pgn,
            user="chesscom",
            source="chesscom",
    ...
    def test_extracts_chesscom_correspondence_black_to_move_positions(self) -> None:
        pgn = self.chesscom_correspondence_games[1]
        positions = extract_positions(
            pgn,
            user="chesscom",
            source="chesscom",
            game_id="correspondence3",
            side_to_move_filter="black",
        )
        self.assertGreater(len(positions), 0)
        self.assertTrue(all(pos["side_to_move"] == "black" for pos in positions))
    ...
    def test_chesscom_correspondence_black_filter_skips_white_user(self) -> None:
        pgn = self.chesscom_correspondence_games[0]
        positions = extract_positions(
            pgn,
            user="chesscom",
            source="chesscom",
            game_id="correspondence4",
            side_to_move_filter="black",
        )
        self.assertEqual(positions, [])
