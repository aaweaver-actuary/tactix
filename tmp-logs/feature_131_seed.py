...
if result is None:
    raise SystemExit("No tactic result for pin bullet fixture")
...
if tactic_row["severity"] < 1.5:
    raise SystemExit("Expected high severity pin tactic (>= 1.5)")

upsert_tactic_with_outcome(conn, tactic_row, outcome_row)
print("seeded pin bullet tactic into data/tactix.duckdb")
