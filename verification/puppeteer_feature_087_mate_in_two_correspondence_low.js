...
console.log('Starting feature 087 Puppeteer run...');
...
const SCREENSHOT_NAME =
  ...
  'feature-087-mate-in-2-correspondence-low-severity-ci-2026-01-26.png';
  ...
  try {
    ...
    const hasLowSeverity = Array.isArray(severityCheck?.tactics)
      ? severityCheck.tactics.some(
          (row) => row.best_uci === 'c5f2' && row.severity <= 1.0,
        )
      : false;
