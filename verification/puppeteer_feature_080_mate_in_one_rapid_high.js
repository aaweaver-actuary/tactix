...
console.log('Starting feature 080 Puppeteer run...');
...
const SCREENSHOT_NAME =
  ...
  'feature-080-mate-in-1-rapid-high-severity-2026-01-26.png';
...
(async () => {
  ...
  try {
    ...
    if (!hasHighSeverity) {
      throw new Error(
        'Expected mate-in-one tactic with high severity (>= 1.5)',
      );
    }
