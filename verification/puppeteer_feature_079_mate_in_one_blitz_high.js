...
const FRONTEND_CMD = process.env.TACTIX_FRONTEND_CMD || 'npm';
const FRONTEND_ARGS = [
  'run',
  'dev',
  '--',
...
const SCREENSHOT_NAME =
  ...
  'feature-079-mate-in-1-blitz-high-severity-2026-01-26.png';
...
function startFrontend() {
  return new Promise((resolve, reject) => {
    const proc = spawn(FRONTEND_CMD, FRONTEND_ARGS, {
