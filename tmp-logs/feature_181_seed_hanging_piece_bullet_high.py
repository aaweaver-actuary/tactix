...
def _hanging_piece_fixture_position() -> dict[str, object]:
    ...
    hanging_chunk = next(
        chunk for chunk in chunks if "Bullet Fixture 9 - Hanging Piece High" in chunk
    )
...
if result is None:
    raise SystemExit("No tactic result for hanging piece bullet fixture")
...
print("seeded hanging piece bullet high tactic into data/tactix.duckdb")
