...
class DiscoveredCheckBulletTests(unittest.TestCase):
    @unittest.skipUnless(shutil.which("stockfish"), "Stockfish binary not on PATH")
    def test_bullet_discovered_check_is_low_severity(self) -> None:
        settings = Settings(
            source="chesscom",
        ...
        conn = get_connection(tmp_dir / "discovered_check_bullet.duckdb")
        init_schema(conn)
