...
const screenshotName =
  ...
  'feature-033-lichess-blitz-incremental-2026-01-25.png';
...
(async () => {
  ...
  try {
    ...
    await page.select('[data-testid="filter-lichess-profile"]', 'blitz');
    ...
    console.error('Feature blitz incremental verification failed:', err);
    process.exit(1);
  } finally {
    await browser.close();
  }
