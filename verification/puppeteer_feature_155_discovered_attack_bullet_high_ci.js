...
console.log('Starting feature 155 Puppeteer run...');
...
const SCREENSHOT_NAME =
  ...
  'feature-155-discovered-attack-bullet-high-severity-ci-2026-01-28.png';
    ...
    const hasHighSeverity = Array.isArray(severityCheck?.tactics)
      ? severityCheck.tactics.some(
          (row) =>
            ...
            row.game_id === 'bullet-discovered-attack-high' &&
