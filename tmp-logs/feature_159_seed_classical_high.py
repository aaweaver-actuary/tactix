...
if result is None:
    raise SystemExit("No tactic result for discovered attack classical high fixture")
...
print("seeded discovered attack classical high tactic into data/tactix.duckdb")
