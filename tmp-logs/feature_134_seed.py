...
if result is None:
    raise SystemExit("No tactic result for pin classical fixture")
...
if tactic_row["motif"] != "pin":
    raise SystemExit("Expected pin motif for classical fixture")
if tactic_row["severity"] < 1.5:
    raise SystemExit("Expected high severity (>= 1.5) for classical pin")

upsert_tactic_with_outcome(conn, tactic_row, outcome_row)
print("seeded pin classical high severity tactic into data/tactix.duckdb")
