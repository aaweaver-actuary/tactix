...
console.log('Starting feature 081 Puppeteer run...');
...
const SCREENSHOT_NAME =
  ...
  'feature-081-mate-in-1-classical-high-severity-ci-2026-01-26.png';
  ...
  try {
    ...
    const severityCheck = await page.evaluate(async (apiBase) => {
      const res = await fetch(
        `${apiBase}/api/dashboard?source=chesscom&motif=mate&time_control=1800`,
        {
