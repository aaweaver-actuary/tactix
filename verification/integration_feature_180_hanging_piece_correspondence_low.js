...
const GAME_ID =
  process.env.TACTIX_HANGING_PIECE_GAME_ID || 'correspondence-hanging-piece-low';
...
(async () => {
  try {
    ...
    console.log('Feature 180 integration check ok');
  } catch (err) {
    console.error('Feature 180 integration check failed:', err);
    process.exit(1);
  }
})();
