...
def _find_failed_attempt_position(
    ...
    raise SystemExit("No failed_attempt outcome found for discovered attack fixture")
...
if outcome_row["result"] != "failed_attempt":
    raise SystemExit("Expected failed_attempt outcome for discovered attack classical fixture")
...
print("seeded discovered attack (classical) failed_attempt outcome into data/tactix.duckdb")
