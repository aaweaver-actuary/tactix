...
class AnalyzeTacticsHelperTests(unittest.TestCase):
    ...
    def test_compute_eval_hanging_piece_unclear_threshold(self) -> None:
        self.assertEqual(impl._compute_eval__hanging_piece_unclear_threshold(None), -300)
    ...
    def test_apply_outcome_unclear_hanging_piece_override(self) -> None:
        result = impl._apply_outcome__unclear_hanging_piece(
            "failed_attempt",
            "hanging_piece",
            "a2a4",
            "a2a3",
            -20,
            impl._compute_eval__hanging_piece_unclear_threshold(None),
        )
        self.assertEqual(result, "unclear")
