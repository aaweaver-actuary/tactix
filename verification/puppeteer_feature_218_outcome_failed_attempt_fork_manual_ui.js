...
const SCREENSHOT_NAME =
  ...
  'feature-218-outcome-failed-attempt-fork-2026-01-30.png';
  ...
  try {
    ...
    const hasTableRow = await page.evaluate(() => {
      ...
      return rows.some((row) => {
        ...
        return text.includes('failed_attempt') && text.includes('fork');
      });
    });
    if (!hasTableRow) {
      throw new Error('Recent tactics table missing failed_attempt fork row');
    }
