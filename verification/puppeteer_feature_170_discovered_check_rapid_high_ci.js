...
console.log('Starting feature 170 Puppeteer run...');
const BACKEND_CMD = path.join(ROOT_DIR, '.venv', 'bin', 'python');
const DUCKDB_PATH =
  process.env.TACTIX_DUCKDB_PATH ||
  path.join(ROOT_DIR, 'data', 'tactix_feature_170.duckdb');
const CHECKPOINT_PATH =
  process.env.TACTIX_CHESSCOM_CHECKPOINT_PATH ||
  path.join(ROOT_DIR, 'data', 'chesscom_feature_170_cursor.txt');
const ANALYSIS_CHECKPOINT_PATH =
  process.env.TACTIX_ANALYSIS_CHECKPOINT_PATH ||
  path.join(ROOT_DIR, 'data', 'analysis_checkpoint_feature_170.json');
...
const SCREENSHOT_NAME =
  ...
  'feature-170-discovered-check-rapid-high-severity-ci-2026-01-29.png';
const EXPECTED_GAME_ID =
  process.env.TACTIX_DISCOVERED_CHECK_GAME_ID || 'rapid-discovered-check-high';
