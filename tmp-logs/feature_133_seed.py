...
if result is None:
    raise SystemExit("No tactic result for pin rapid fixture")
...
if tactic_row["motif"] != "pin":
    raise SystemExit("Expected pin motif for rapid fixture")
if tactic_row["severity"] < 1.5:
    raise SystemExit("Expected high severity (>= 1.5) for rapid pin")

upsert_tactic_with_outcome(conn, tactic_row, outcome_row)
print("seeded pin rapid high severity tactic into data/tactix.duckdb")
