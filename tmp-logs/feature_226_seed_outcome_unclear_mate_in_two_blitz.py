...
def _find_unclear_position(
    ...
    raise SystemExit("No unclear outcome found for mate in two fixture")


def _mate_in_two_fixture_position() -> dict[str, object]:
    ...
    positions = extract_positions(
        ...
        "chesscom",
        "chesscom",
        game_id="blitz-mate-2-unclear",
        side_to_move_filter="black",
    )
    return next(pos for pos in positions if pos["uci"] == "c5f2")
...
position = _mate_in_two_fixture_position()
...
if outcome_row["result"] != "unclear":
    raise SystemExit("Expected unclear outcome for mate in two blitz fixture")
...
print("seeded mate in two (blitz) unclear outcome into data/tactix.duckdb")
